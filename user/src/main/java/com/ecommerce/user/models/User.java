...
public class User {
    ...
    private String email;
    private String phoneNo;
    //    This is the default role is CUSTOMER,
    //    but if I provide a role from mail carrier, it will assign as I pass ADMIN so it will assign
    private UserRole role = UserRole.CUSTOMER;
    private Address address;
